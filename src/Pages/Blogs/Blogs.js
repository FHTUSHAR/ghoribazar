...
const Blogs = () => {
    return (
        <div className='text-white w-2/3 mx-auto '>
            <div className='border border-primary w-50 shadow mb-4 m-auto p-3 rounded shadow-xl shadow-400blue- my-5'>
            ...
            <div className='border border-primary w-50 shadow mb-4 m-auto p-3 rounded shadow-xl shadow-blue-400 my-5'>
